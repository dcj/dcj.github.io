...
var self__ = this;
var ___$1 = this;
var fexpr__108025 = taoensso.sente.packers.transit.get_transit_writer_fn(self__.transit_fmt,self__.writer_opts);
return (fexpr__108025.cljs$core$IFn$_invoke$arity$1 ? fexpr__108025.cljs$core$IFn$_invoke$arity$1(x) : fexpr__108025.call(null,x));
}));

(taoensso.sente.packers.transit.TransitPacker.prototype.taoensso$sente$interfaces$IPacker$unpack$arity$2 = (function (_,s){
var self__ = this;
var ___$1 = this;
var fexpr__108028 = taoensso.sente.packers.transit.get_transit_reader_fn(self__.transit_fmt,self__.reader_opts);
return (fexpr__108028.cljs$core$IFn$_invoke$arity$1 ? fexpr__108028.cljs$core$IFn$_invoke$arity$1(s) : fexpr__108028.call(null,s));
}));
...
var G__108030 = arguments.length;
switch (G__108030) {
case 0:
...
var e_108041 = (function (){try{if((function (x){
return cljs.core.contains_QMARK_((function (){var G__108033 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"json","json",1279968570),null], null), null);
return (taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1 ? taoensso.truss.impl.set_STAR_.cljs$core$IFn$_invoke$arity$1(G__108033) : taoensso.truss.impl.set_STAR_.call(null,G__108033));
})(),x);
})(transit_fmt)){
return null;
} else {
...
}catch (e108032){if((e108032 instanceof Error)){
var e_108041 = e108032;
return e_108041;
} else {
throw e108032;
...
taoensso.truss.impl._invar_violation_BANG_(true,"taoensso.sente.packers.transit",102,"([:el #{:json}] transit-fmt)",transit_fmt,e_108041,null);
}
...
}catch (e108034){if((e108034 instanceof Error)){
var e = e108034;
return e;
} else {
throw e108034;
...
}catch (e108035){if((e108035 instanceof Error)){
var e = e108035;
return e;
} else {
throw e108035;
