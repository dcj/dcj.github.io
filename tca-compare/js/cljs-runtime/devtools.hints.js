...
var map__95968 = top_item;
var map__95968__$1 = (((((!((map__95968 == null))))?(((((map__95968.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__95968.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__95968):map__95968);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95968__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95968__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__95968__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e95967){var _e = e95967;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___95992 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___95992)){
var seen_errors_95993 = temp__5733__auto___95992;
if(cljs.core.truth_(seen_errors_95993.has(self))){
} else {
seen_errors_95993.add(self);

var temp__5735__auto___95994 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___95994)){
var sense_95995 = temp__5735__auto___95994;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_95995)].join(''));
} else {
}
}
} else {
