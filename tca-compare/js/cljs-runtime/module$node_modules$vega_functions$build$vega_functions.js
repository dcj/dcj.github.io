...
utcweek:vegaTime.utcweek,dayofyear:vegaTime.dayofyear,utcdayofyear:vegaTime.utcdayofyear,warn:warn,info:info,debug:debug,extent:vegaUtil.extent,inScope:inScope,intersect:function(b,opt,group){if(!b)return[];var $jscomp$destructuring$var457=$jscomp.makeIterator(b);b=$jscomp$destructuring$var457.next().value;$jscomp$destructuring$var457=$jscomp$destructuring$var457.next().value;b=(new vegaScenegraph.Bounds).set(b[0],b[1],$jscomp$destructuring$var457[0],$jscomp$destructuring$var457[1]);group=group||
