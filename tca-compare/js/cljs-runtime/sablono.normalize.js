...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__96196){
var vec__96197 = p__96196;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96197,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96197,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__96206_SHARP_){
return (((p1__96206_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__96206_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__96212,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__96212;
}
});
...
var len__4736__auto___96271 = arguments.length;
var i__4737__auto___96272 = (0);
while(true){
if((i__4737__auto___96272 < len__4736__auto___96271)){
args__4742__auto__.push((arguments[i__4737__auto___96272]));

var G__96273 = (i__4737__auto___96272 + (1));
i__4737__auto___96272 = G__96273;
continue;
} else {
}
break;
...
var G__96215 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__96215,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__96215;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq96214){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq96214));
}));
...
var vec__96223 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__96227 = cljs.core.ffirst(matches);
var fexpr__96226 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__96226.cljs$core$IFn$_invoke$arity$1 ? fexpr__96226.cljs$core$IFn$_invoke$arity$1(G__96227) : fexpr__96226.call(null,G__96227));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96223,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96223,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__96220_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__96220_SHARP_))){
return p1__96220_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__96221_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__96221_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__96248){
var vec__96249 = p__96248;
var seq__96250 = cljs.core.seq(vec__96249);
var first__96251 = cljs.core.first(seq__96250);
var seq__96250__$1 = cljs.core.next(seq__96250);
var tag = first__96251;
var content = seq__96250__$1;
...
var vec__96255 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96255,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96255,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__96255,(2),null);
