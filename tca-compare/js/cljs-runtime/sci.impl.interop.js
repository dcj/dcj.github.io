...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__105752){
var vec__105754 = p__105752;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105754,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105754,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__105790,args){
var vec__105795 = p__105790;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105795,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105795,(1),null);
...
var vec__105801 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105801,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__105801,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__105814,sym){
var map__105815 = p__105814;
var map__105815__$1 = (((((!((map__105815 == null))))?(((((map__105815.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__105815.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__105815):map__105815);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105815__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105815__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__105827,sym){
var map__105828 = p__105827;
var map__105828__$1 = (((((!((map__105828 == null))))?(((((map__105828.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__105828.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__105828):map__105828);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105828__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__105828__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
