...
var len__4736__auto___105766 = arguments.length;
var i__4737__auto___105767 = (0);
while(true){
if((i__4737__auto___105767 < len__4736__auto___105766)){
args__4742__auto__.push((arguments[i__4737__auto___105767]));

var G__105768 = (i__4737__auto___105767 + (1));
i__4737__auto___105767 = G__105768;
continue;
} else {
}
break;
...
/** @this {Function} */
(helix.core.$.cljs$lang$applyTo = (function (seq105670){
var G__105671 = cljs.core.first(seq105670);
var seq105670__$1 = cljs.core.next(seq105670);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__105671,seq105670__$1);
}));
...
var helix$core$IExtractType$_type$dyn_105798 = (function (factory){
...
return helix$core$IExtractType$_type$dyn_105798(factory);
}
});
...
var G__105804__i = 0, G__105804__a = new Array(arguments.length -  0);
while (G__105804__i < G__105804__a.length) {G__105804__a[G__105804__i] = arguments[G__105804__i + 0]; ++G__105804__i;}
  args = new cljs.core.IndexedSeq(G__105804__a,0,null);
} 
return helix$core$factory_$_factory__delegate.call(this,args);};
helix$core$factory_$_factory.cljs$lang$maxFixedArity = 0;
helix$core$factory_$_factory.cljs$lang$applyTo = (function (arglist__105806){
...
;
(x105711.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x105711.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
var args = null;
if (arguments.length > 0) {
var G__105809__i = 0, G__105809__a = new Array(arguments.length -  0);
while (G__105809__i < G__105809__a.length) {G__105809__a[G__105809__i] = arguments[G__105809__i + 0]; ++G__105809__i;}
  args = new cljs.core.IndexedSeq(G__105809__a,0,null);
} 
...
helix$core$cljs_factory_$_factory.cljs$lang$applyTo = (function (arglist__105810){
var args = cljs.core.seq(arglist__105810);
...
;
(x105721.helix$core$IExtractType$ = cljs.core.PROTOCOL_SENTINEL);

(x105721.helix$core$IExtractType$_type$arity$1 = (function (_){
var ___$1 = this;
return type;
}));
...
var G__105742 = arguments.length;
switch (G__105742) {
case 1:
...
var G__105745 = helix.core.extract_cljs_props(o);
var G__105746 = helix.core.extract_cljs_props(o_SINGLEQUOTE_);
return (compare.cljs$core$IFn$_invoke$arity$2 ? compare.cljs$core$IFn$_invoke$arity$2(G__105745,G__105746) : compare.call(null,G__105745,G__105746));
}));
}));
...
return render(this$,helix.core.extract_cljs_props(this$.props),this$.state);
});
