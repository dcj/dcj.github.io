...
function parsePrimaryExpression(){if(match("(")){expect("(");var type=parseExpression();expect(")");return type}if(match("[")){type=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),type.push(null)):(type.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_3349=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_3349.elements=type;return JSCompiler_object_inline_value_3349}if(match("{")){type=[];JSCompiler_object_inline_value_3349=
{};var JSCompiler_object_inline_literal_3350=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_3351=lookahead;if(3===JSCompiler_object_inline_value_3351.type){var JSCompiler_object_inline_literal_3352=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_3351=parseConditionalExpression();JSCompiler_object_inline_value_3351=finishProperty("init",JSCompiler_object_inline_literal_3352,JSCompiler_object_inline_value_3351)}else 2===
JSCompiler_object_inline_value_3351.type||7===JSCompiler_object_inline_value_3351.type?(throwUnexpected(JSCompiler_object_inline_value_3351),JSCompiler_object_inline_value_3351=void 0):(JSCompiler_object_inline_literal_3352=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_3351=parseConditionalExpression(),JSCompiler_object_inline_value_3351=finishProperty("init",JSCompiler_object_inline_literal_3352,JSCompiler_object_inline_value_3351));JSCompiler_object_inline_literal_3352="Identifier"===
JSCompiler_object_inline_value_3351.key.type?JSCompiler_object_inline_value_3351.key.name:JSCompiler_object_inline_literal_3350(JSCompiler_object_inline_value_3351.key.value);JSCompiler_object_inline_literal_3352="$"+JSCompiler_object_inline_literal_3352;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_3349,JSCompiler_object_inline_literal_3352)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_3349[JSCompiler_object_inline_literal_3352]=
!0;type.push(JSCompiler_object_inline_value_3351);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_3349=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_3349.properties=type;return JSCompiler_object_inline_value_3349}type=lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_3349=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),
JSCompiler_object_inline_value_3349=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_3349=finishLiteral(type);else if(5===type)type=lex(),type.value=null,JSCompiler_object_inline_value_3349=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_3349=source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_3349,
"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_3350=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_3352=JSCompiler_object_inline_value_3351=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_3349=source[index$jscomp$0++],JSCompiler_object_inline_literal_3350+=JSCompiler_object_inline_value_3349,"\\"===JSCompiler_object_inline_value_3349)JSCompiler_object_inline_value_3349=source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_3349.charCodeAt(0))&&
throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_3350+=JSCompiler_object_inline_value_3349;else if(isLineTerminator(JSCompiler_object_inline_value_3349.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_3351)"]"===JSCompiler_object_inline_value_3349&&(JSCompiler_object_inline_value_3351=!1);else if("/"===JSCompiler_object_inline_value_3349){JSCompiler_object_inline_literal_3352=!0;break}else"["===JSCompiler_object_inline_value_3349&&
(JSCompiler_object_inline_value_3351=!0);JSCompiler_object_inline_literal_3352||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_3349=JSCompiler_object_inline_literal_3350.substr(1,JSCompiler_object_inline_literal_3350.length-2);for(value=JSCompiler_object_inline_literal_3352="";index$jscomp$0<length;){JSCompiler_object_inline_value_3351=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_3351.charCodeAt(0)))break;++index$jscomp$0;"\\"===
JSCompiler_object_inline_value_3351&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_3351,JSCompiler_object_inline_literal_3352+=JSCompiler_object_inline_value_3351)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_3351=value;value=testRegExp(JSCompiler_object_inline_value_3349,JSCompiler_object_inline_value_3351);JSCompiler_object_inline_value_3349=finishLiteral({literal:JSCompiler_object_inline_literal_3350+
