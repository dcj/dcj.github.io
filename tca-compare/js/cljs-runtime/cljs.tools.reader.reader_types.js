...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_103391 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_103391(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_103394 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_103394(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_103395 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_103395(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_103398 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_103398(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_103401 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_103401(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_103405 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_103405(reader);
}
});
...
var G__103378 = arguments.length;
switch (G__103378) {
case 1:
...
var G__103384 = arguments.length;
switch (G__103384) {
case 1:
...
var G__103434 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__103435 = s.append(c);
c = G__103434;
s = G__103435;
continue;
}
