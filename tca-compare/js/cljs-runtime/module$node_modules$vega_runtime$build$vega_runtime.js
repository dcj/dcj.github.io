...
op);if(spec.data){data={};for(var name in spec.data)data.$jscomp$loop$prop$data$587$626=ctx.data[name]||(ctx.data[name]={}),spec.data[name].forEach(function($jscomp$loop$625){return function(role){return $jscomp$loop$625.$jscomp$loop$prop$data$587$626[role]=op}}(data)),data={$jscomp$loop$prop$data$587$626:data.$jscomp$loop$prop$data$587$626}}},resolve:function(){(this.unresolved||[]).forEach(function(fn){return fn()});delete this.unresolved;return this},operator:function(spec,update){this.add(spec,
