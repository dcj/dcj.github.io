...
darkGreen:"3a3a3a215748006f4d048942489e4276b340a6c63dd2d836ffeb2cffffaa",darkMulti:"3737371f5287197d8c29a86995ce3fffe800ffffff",darkRed:"3434347036339e3c38cc4037e75d1eec8620eeab29f0ce32ffeb2c"},function(_){return interpolateColors(colors$jscomp$0(_))});var defaultFormatter=function(value){return vegaUtil.isArray(value)?value.map(function(v){return String(v)}):String(value)},ascending=function(a,b){return a[1]-b[1]},descending=function(a,b){return b[1]-a[1]},$jscomp$compprop46={},symbols=($jscomp$compprop46.quantile=
"quantiles",$jscomp$compprop46.quantize="thresholds",$jscomp$compprop46.threshold="domain",$jscomp$compprop46);$jscomp$compprop46={};var formats=($jscomp$compprop46.quantile="quantiles",$jscomp$compprop46.quantize="domain",$jscomp$compprop46),formatRange=function(format){return function(value,index,array){index=array[index+1];array=array.max;array=null!=array?array:Infinity;index=null!=index?index:array;value=Number.isFinite(value)?format(value):null;index=Number.isFinite(index)?format(index):null;
