...
var G__103712 = arguments.length;
switch (G__103712) {
case 2:
...
var G__103730 = arguments.length;
switch (G__103730) {
case 2:
...
var G__103745 = arguments.length;
switch (G__103745) {
case 2:
...
var G__103919 = cljs.core.next(xs);
var G__103920 = cljs.core.next(ys);
xs = G__103919;
ys = G__103920;
continue;
} else {
...
var G__103770 = arguments.length;
switch (G__103770) {
case 2:
...
while(true){
if((n < cnt)){
var nval = (function (){var G__103779 = val;
var G__103780 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__103779,G__103780) : f.call(null,G__103779,G__103780));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__103812 = val__$1;
var G__103813 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__103812,G__103813) : f.call(null,G__103812,G__103813));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__103824 = val__$1;
var G__103825 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__103824,G__103825) : f.call(null,G__103824,G__103825));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__103967 = cljs.core.next(es);
var G__103968 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__103967;
tcoll__$1 = G__103968;
continue;
} else {
...
var G__103972 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__103973 = cljs.core.next(es);
ret = G__103972;
es = G__103973;
continue;
} else {
