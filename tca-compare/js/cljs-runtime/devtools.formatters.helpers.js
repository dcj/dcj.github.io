...
var G__95990 = devtools.prefs.pref(v);
v = G__95990;
continue;
} else {
return v;
...
}catch (e95947){var _e__95193__auto__ = e95947;
return false;
}})();
...
}catch (e95952){var _e__95193__auto__ = e95952;
return false;
}})();
...
}catch (e95955){var _e__95193__auto__ = e95955;
return false;
}}
}
});
...
var vec__95972 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95972,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__95972,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__95979_SHARP_);
}),template);
});
