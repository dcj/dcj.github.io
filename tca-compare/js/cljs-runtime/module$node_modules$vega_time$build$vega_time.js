...
UNITS=TIME_UNITS.reduce(function(o,u,i){return o[u]=1+i,o},{}),$jscomp$compprop39={},defaultSpecifiers=($jscomp$compprop39.year="%Y ",$jscomp$compprop39.quarter="Q%q ",$jscomp$compprop39.month="%b ",$jscomp$compprop39.date="%d ",$jscomp$compprop39.week="W%U ",$jscomp$compprop39.day="%a ",$jscomp$compprop39.dayofyear="%j ",$jscomp$compprop39.hours="%H:00",$jscomp$compprop39.minutes="00:%M",$jscomp$compprop39.seconds=":%S",$jscomp$compprop39.milliseconds=".%L",$jscomp$compprop39["year-month"]="%Y-%m ",
$jscomp$compprop39["year-month-date"]="%Y-%m-%d ",$jscomp$compprop39["hours-minutes"]="%H:%M",$jscomp$compprop39),t0=new Date;$jscomp$compprop39={};var localGet=($jscomp$compprop39.year=function(d){return d.getFullYear()},$jscomp$compprop39.quarter=function(d){return Math.floor(d.getMonth()/3)},$jscomp$compprop39.month=function(d){return d.getMonth()},$jscomp$compprop39.date=function(d){return d.getDate()},$jscomp$compprop39.hours=function(d){return d.getHours()},$jscomp$compprop39.minutes=function(d){return d.getMinutes()},
$jscomp$compprop39.seconds=function(d){return d.getSeconds()},$jscomp$compprop39.milliseconds=function(d){return d.getMilliseconds()},$jscomp$compprop39.dayofyear=function(d){return localDayOfYear(d)},$jscomp$compprop39.week=function(d){return localWeekNum(d)},$jscomp$compprop39.weekday=function(d,y){return weekday(localWeekNum(d),d.getDay(),localYear(y).getDay())},$jscomp$compprop39.day=function(d,y){return weekday(1,d.getDay(),localYear(y).getDay())},$jscomp$compprop39);$jscomp$compprop39={};var localInv=
($jscomp$compprop39.quarter=function(q){return 3*q},$jscomp$compprop39.week=function(w,y){return weekday(w,0,localYear(y).getDay())},$jscomp$compprop39);$jscomp$compprop39={};var utcGet=($jscomp$compprop39.year=function(d){return d.getUTCFullYear()},$jscomp$compprop39.quarter=function(d){return Math.floor(d.getUTCMonth()/3)},$jscomp$compprop39.month=function(d){return d.getUTCMonth()},$jscomp$compprop39.date=function(d){return d.getUTCDate()},$jscomp$compprop39.hours=function(d){return d.getUTCHours()},
$jscomp$compprop39.minutes=function(d){return d.getUTCMinutes()},$jscomp$compprop39.seconds=function(d){return d.getUTCSeconds()},$jscomp$compprop39.milliseconds=function(d){return d.getUTCMilliseconds()},$jscomp$compprop39.dayofyear=function(d){return utcDayOfYear(d)},$jscomp$compprop39.week=function(d){return utcWeekNum(d)},$jscomp$compprop39.day=function(d,y){return weekday(1,d.getUTCDay(),utcFirst(y))},$jscomp$compprop39.weekday=function(d,y){return weekday(utcWeekNum(d),d.getUTCDay(),utcFirst(y))},
$jscomp$compprop39);$jscomp$compprop39={};var utcInv=($jscomp$compprop39.quarter=function(q){return 3*q},$jscomp$compprop39.week=function(w,y){return weekday(w,0,utcFirst(y))},$jscomp$compprop39);$jscomp$compprop39={};var timeIntervals=($jscomp$compprop39.year=d3Time.timeYear,$jscomp$compprop39.quarter=d3Time.timeMonth.every(3),$jscomp$compprop39.month=d3Time.timeMonth,$jscomp$compprop39.week=d3Time.timeWeek,$jscomp$compprop39.date=d3Time.timeDay,$jscomp$compprop39.day=d3Time.timeDay,$jscomp$compprop39.dayofyear=
d3Time.timeDay,$jscomp$compprop39.hours=d3Time.timeHour,$jscomp$compprop39.minutes=d3Time.timeMinute,$jscomp$compprop39.seconds=d3Time.timeSecond,$jscomp$compprop39.milliseconds=d3Time.timeMillisecond,$jscomp$compprop39);$jscomp$compprop39={};var utcIntervals=($jscomp$compprop39.year=d3Time.utcYear,$jscomp$compprop39.quarter=d3Time.utcMonth.every(3),$jscomp$compprop39.month=d3Time.utcMonth,$jscomp$compprop39.week=d3Time.utcWeek,$jscomp$compprop39.date=d3Time.utcDay,$jscomp$compprop39.day=d3Time.utcDay,
$jscomp$compprop39.dayofyear=d3Time.utcDay,$jscomp$compprop39.hours=d3Time.utcHour,$jscomp$compprop39.minutes=d3Time.utcMinute,$jscomp$compprop39.seconds=d3Time.utcSecond,$jscomp$compprop39.milliseconds=d3Time.utcMillisecond,$jscomp$compprop39),Milli="year month date hours minutes seconds milliseconds".split(" ");$jscomp$compprop39=Milli.slice(0,-1);var Minutes=$jscomp$compprop39.slice(0,-1),Hours=Minutes.slice(0,-1),Day=Hours.slice(0,-1),Month=["year","month"],Year=["year"],intervals=[[$jscomp$compprop39,
1,1E3],[$jscomp$compprop39,5,5E3],[$jscomp$compprop39,15,15E3],[$jscomp$compprop39,30,3E4],[Minutes,1,6E4],[Minutes,5,3E5],[Minutes,15,9E5],[Minutes,30,18E5],[Hours,1,36E5],[Hours,3,108E5],[Hours,6,216E5],[Hours,12,432E5],[Day,1,864E5],[["year","week"],1,6048E5],[Month,1,2592E6],[Month,3,7776E6],[Year,1,31536E6]];exports.DATE="date";exports.DAY="day";exports.DAYOFYEAR="dayofyear";exports.HOURS="hours";exports.MILLISECONDS="milliseconds";exports.MINUTES="minutes";exports.MONTH="month";exports.QUARTER=
"quarter";exports.SECONDS="seconds";exports.TIME_UNITS=TIME_UNITS;exports.WEEK="week";exports.YEAR="year";exports.dayofyear=function(d){return localDayOfYear(new Date(d))};exports.timeBin=function(opt){var ext=opt.extent;opt=opt.maxbins||40;var target=Math.abs(vegaUtil.span(ext))/opt,i$jscomp$0=d3Array.bisector(function(i){return i[2]}).right(intervals,target);i$jscomp$0===intervals.length?(target=Year,ext=d3Array.tickStep(ext[0]/31536E6,ext[1]/31536E6,opt)):i$jscomp$0?(i$jscomp$0=intervals[target/
intervals[i$jscomp$0-1][2]<intervals[i$jscomp$0][2]/target?i$jscomp$0-1:i$jscomp$0],target=i$jscomp$0[0],ext=i$jscomp$0[1]):(target=Milli,ext=Math.max(d3Array.tickStep(ext[0],ext[1],opt),1));return{units:target,step:ext}};exports.timeFloor=function(units,step){return floor(units,step||1,localGet,localInv,localDate)};exports.timeInterval=function(unit){return timeIntervals[unit]};exports.timeOffset=function(unit,date,step){return(unit=timeIntervals[unit])?unit.offset(date,step):void 0};exports.timeSequence=
function(unit,start,stop,step){return(unit=timeIntervals[unit])?unit.range(start,stop,step):void 0};exports.timeUnitSpecifier=function(units,specifiers){specifiers=vegaUtil.extend({},defaultSpecifiers,specifiers);units=timeUnits(units);var n=units.length,fmt="",start,end;for(start=0;start<n;)for(end=units.length;end>start;--end){var key=units.slice(start,end).join("-");if(null!=specifiers[key]){fmt+=specifiers[key];start=end;break}}return fmt.trim()};exports.timeUnits=timeUnits;exports.utcFloor=function(units,
step){return floor(units,step||1,utcGet,utcInv,utcDate)};exports.utcInterval=function(unit){return utcIntervals[unit]};exports.utcOffset=function(unit,date,step){return(unit=utcIntervals[unit])?unit.offset(date,step):void 0};exports.utcSequence=function(unit,start,stop,step){return(unit=utcIntervals[unit])?unit.range(start,stop,step):void 0};exports.utcdayofyear=function(d){return utcDayOfYear(new Date(d))};exports.utcweek=function(d){return utcWeekNum(new Date(d))};exports.week=function(d){return localWeekNum(new Date(d))};
