...
var len__4736__auto___96035 = arguments.length;
var i__4737__auto___96036 = (0);
while(true){
if((i__4737__auto___96036 < len__4736__auto___96035)){
args__4742__auto__.push((arguments[i__4737__auto___96036]));

var G__96037 = (i__4737__auto___96036 + (1));
i__4737__auto___96036 = G__96037;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq96002){
var G__96003 = cljs.core.first(seq96002);
var seq96002__$1 = cljs.core.next(seq96002);
var G__96004 = cljs.core.first(seq96002__$1);
var seq96002__$2 = cljs.core.next(seq96002__$1);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__96008_SHARP_){
return (!((cljs.core.meta(p1__96008_SHARP_) == null)));
})))){
...
var map__96011 = opts;
var map__96011__$1 = (((((!((map__96011 == null))))?(((((map__96011.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__96011.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__96011):map__96011);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96011__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e96016){var _e__95193__auto__ = e96016;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e96018){var _e__95193__auto__ = e96018;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__96020 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__96021 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__96021);

try{var map__96022 = opts;
var map__96022__$1 = (((((!((map__96022 == null))))?(((((map__96022.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__96022.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__96022):map__96022);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96022__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__96020);
}});
...
var temp__5733__auto___96055 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___96055)){
var managed_print_level_96056 = temp__5733__auto___96055;
var _STAR_print_level_STAR__orig_val__96026_96057 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__96027_96058 = managed_print_level_96056;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__96027_96058);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__96026_96057);
}} else {
job_fn();
}
