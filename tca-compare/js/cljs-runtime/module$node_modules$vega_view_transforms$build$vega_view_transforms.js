...
vegaDataflow.Transform,{transform:function(_,pulse){var view=pulse.dataflow;_.mark.items.forEach(function(group){if(_.layout){for(var opt=_.layout,groups=group.items,n=groups.length,i=0,mark,items,JSCompiler_object_inline_marks_3392=[],JSCompiler_object_inline_rowheaders_3393=[],JSCompiler_object_inline_rowfooters_3394=[],JSCompiler_object_inline_colheaders_3395=[],JSCompiler_object_inline_colfooters_3396=[],JSCompiler_object_inline_rowtitle_3397=null,JSCompiler_object_inline_coltitle_3398=null;i<
n;++i)if(mark=groups[i],items=mark.items,"group"===mark.marktype)switch(mark.role){case "axis":case "legend":case "title":break;case "row-header":JSCompiler_object_inline_rowheaders_3393.push.apply(JSCompiler_object_inline_rowheaders_3393,$jscomp.arrayFromIterable(items));break;case "row-footer":JSCompiler_object_inline_rowfooters_3394.push.apply(JSCompiler_object_inline_rowfooters_3394,$jscomp.arrayFromIterable(items));break;case "column-header":JSCompiler_object_inline_colheaders_3395.push.apply(JSCompiler_object_inline_colheaders_3395,
$jscomp.arrayFromIterable(items));break;case "column-footer":JSCompiler_object_inline_colfooters_3396.push.apply(JSCompiler_object_inline_colfooters_3396,$jscomp.arrayFromIterable(items));break;case "row-title":JSCompiler_object_inline_rowtitle_3397=items[0];break;case "column-title":JSCompiler_object_inline_coltitle_3398=items[0];break;default:JSCompiler_object_inline_marks_3392.push.apply(JSCompiler_object_inline_marks_3392,$jscomp.arrayFromIterable(items))}mark="flush"===opt.bounds?boundFlush:
boundFull;groups=opt.offset;items=opt.columns||JSCompiler_object_inline_marks_3392.length;var nrows=0>=items?1:Math.ceil(JSCompiler_object_inline_marks_3392.length/items),cells=nrows*items;n=gridLayout(view,JSCompiler_object_inline_marks_3392,opt);n.empty()&&n.set(0,0,0,0);if(JSCompiler_object_inline_rowheaders_3393){i=get(opt.headerBand,"row",null);var x=layoutHeaders(view,JSCompiler_object_inline_rowheaders_3393,JSCompiler_object_inline_marks_3392,items,nrows,-get(groups,"rowHeader"),min,0,mark,
"x1",0,items,1,i)}if(JSCompiler_object_inline_colheaders_3395){i=get(opt.headerBand,"column",null);var y=layoutHeaders(view,JSCompiler_object_inline_colheaders_3395,JSCompiler_object_inline_marks_3392,items,items,-get(groups,"columnHeader"),min,1,mark,"y1",0,1,items,i)}if(JSCompiler_object_inline_rowfooters_3394){i=get(opt.footerBand,"row",null);var x2=layoutHeaders(view,JSCompiler_object_inline_rowfooters_3394,JSCompiler_object_inline_marks_3392,items,nrows,get(groups,"rowFooter"),max$jscomp$0,0,
mark,"x2",items-1,items,1,i)}if(JSCompiler_object_inline_colfooters_3396){i=get(opt.footerBand,"column",null);var y2=layoutHeaders(view,JSCompiler_object_inline_colfooters_3396,JSCompiler_object_inline_marks_3392,items,items,get(groups,"columnFooter"),max$jscomp$0,1,mark,"y2",cells-items,1,items,i)}JSCompiler_object_inline_rowtitle_3397&&(JSCompiler_object_inline_rowheaders_3393=get(opt.titleAnchor,"row"),JSCompiler_object_inline_marks_3392=get(groups,"rowTitle"),JSCompiler_object_inline_marks_3392=
"end"===JSCompiler_object_inline_rowheaders_3393?x2+JSCompiler_object_inline_marks_3392:x-JSCompiler_object_inline_marks_3392,i=get(opt.titleBand,"row",.5),layoutTitle(view,JSCompiler_object_inline_rowtitle_3397,JSCompiler_object_inline_marks_3392,0,n,i));JSCompiler_object_inline_coltitle_3398&&(JSCompiler_object_inline_rowheaders_3393=get(opt.titleAnchor,"column"),JSCompiler_object_inline_marks_3392=get(groups,"columnTitle"),JSCompiler_object_inline_marks_3392="end"===JSCompiler_object_inline_rowheaders_3393?
y2+JSCompiler_object_inline_marks_3392:y-JSCompiler_object_inline_marks_3392,i=get(opt.titleBand,"column",.5),layoutTitle(view,JSCompiler_object_inline_coltitle_3398,JSCompiler_object_inline_marks_3392,1,n,i))}layoutGroup(view,group,_)});return shouldReflow(_.mark.group)?pulse.reflow():pulse}});exports.bound=Bound;exports.identifier=Identifier;exports.mark=Mark;exports.overlap=Overlap;exports.render=Render;exports.viewlayout=ViewLayout;Object.defineProperty(exports,"__esModule",{value:!0})})}
