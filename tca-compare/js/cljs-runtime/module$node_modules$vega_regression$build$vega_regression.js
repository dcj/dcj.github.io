...
model.predict(x)])}):vegaStatistics.sampleCurve(model.predict,dom,25,200).forEach(add)}}});this.value&&(out.rem=this.value);this.value=out.add=out.source=values}return out}});exports.loess=Loess;exports.regression=Regression;Object.defineProperty(exports,"__esModule",{value:!0})})}
