...
var G__104678 = arguments.length;
switch (G__104678) {
case 3:
...
var G__105012 = (function (){var G__104682 = sb;
G__104682.append(cljs.tools.reader.reader_types.read_char(rdr));

return G__104682;
})();
var G__105013 = cljs.tools.reader.reader_types.peek_char(rdr);
sb = G__105012;
ch = G__105013;
continue;
}
...
var temp__5733__auto____$2 = (function (){var G__104685 = (function (){var G__104688 = rdr;
cljs.tools.reader.reader_types.unread(G__104688,ch);

return G__104688;
})();
var G__104686 = ch;
var G__104687 = opts;
return (cljs.tools.reader.edn.read_tagged.cljs$core$IFn$_invoke$arity$3 ? cljs.tools.reader.edn.read_tagged.cljs$core$IFn$_invoke$arity$3(G__104685,G__104686,G__104687) : cljs.tools.reader.edn.read_tagged.call(null,G__104685,G__104686,G__104687));
})();
...
var vec__104706 = cljs.tools.reader.edn.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104706,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104706,(1),null);
...
var G__105068 = (((!((mret === rdr))))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,mret):a);
a = G__105068;
continue;
} else {
var o = (function (){var G__104712 = (function (){var G__104717 = rdr;
cljs.tools.reader.reader_types.unread(G__104717,ch);
...
var G__104715 = null;
var G__104716 = opts;
return (cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4(G__104712,G__104713,G__104715,G__104716) : cljs.tools.reader.edn.read.call(null,G__104712,G__104713,G__104715,G__104716));
})();
var G__105074 = (((!((o === rdr))))?cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(a,o):a);
a = G__105074;
continue;
}
}
...
var vec__104792 = cljs.tools.reader.edn.starting_line_col_info(rdr);
var start_line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104792,(0),null);
var start_column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__104792,(1),null);
...
var sb = (function (){var G__104802 = (new goog.string.StringBuffer());
G__104802.append(initch);
...
var G__105093 = (function (){var G__104809 = sb;
G__104809.append(ch);

return G__104809;
})();
var G__105094 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__105093;
ch = G__105094;
continue;
}
...
while(true){
var G__104832 = ch;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__104832)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\\",G__104832)){
var G__105115 = (function (){var G__104834 = sb;
G__104834.append(cljs.tools.reader.edn.escape_char(sb,rdr));

return G__104834;
})();
var G__105116 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__105115;
ch = G__105116;
continue;
} else {
...
var G__105117 = (function (){var G__104837 = sb;
G__104837.append(ch);

return G__104837;
})();
var G__105118 = cljs.tools.reader.reader_types.read_char(rdr);
sb = G__105117;
ch = G__105118;
continue;
...
var G__104887 = rdr;
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4 ? cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$4(G__104887,true,null,true) : cljs.tools.reader.edn.read.call(null,G__104887,true,null,true));
...
var temp__5733__auto__ = (function (){var G__104905 = token;
var G__104905__$1 = (((G__104905 == null))?null:cljs.tools.reader.impl.commons.parse_symbol(G__104905));
if((G__104905__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_(G__104905__$1);
}
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__104917 = sym;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__104917)){
return Number.NaN;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__104917)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__104917)){
...
var G__104937 = arguments.length;
switch (G__104937) {
case 1:
...
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__104940,reader){
var map__104942 = p__104940;
var map__104942__$1 = (((((!((map__104942 == null))))?(((((map__104942.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__104942.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__104942):map__104942);
var opts = map__104942__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104942__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
