...
var G__103105 = arguments.length;
switch (G__103105) {
case 0:
...
var i_103199 = (0);
while(true){
if((i_103199 < arr.length)){
(arr[i_103199] = null);

var G__103200 = (i_103199 + (1));
i_103199 = G__103200;
continue;
} else {
}
...
var G__103206 = x__$1;
var G__103207 = k;
var G__103208 = (level - (1));
var G__103209 = update;
x = G__103206;
k = G__103207;
level = G__103208;
update = G__103209;
...
var i_103211 = (self__.level + (1));
while(true){
if((i_103211 <= (new_level + (1)))){
(update[i_103211] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_103213 = (update[i]).forward;
(x__$2.forward[i] = (links_103213[i]));

(links_103213[i] = x__$2);
...
var i_103215 = (0);
while(true){
if((i_103215 <= self__.level)){
var links_103216 = (update[i_103215]).forward;
if((x__$1 === (((i_103215 < links_103216.length))?(links_103216[i_103215]):null))){
(links_103216[i_103215] = (x__$1.forward[i_103215]));

var G__103217 = (i_103215 + (1));
i_103215 = G__103217;
continue;
} else {
var G__103218 = (i_103215 + (1));
i_103215 = G__103218;
continue;
}
} else {
...
var G__103221 = nx;
var G__103222 = (level__$1 - (1));
x = G__103221;
level__$1 = G__103222;
continue;
} else {
var G__103223 = x;
var G__103224 = (level__$1 - (1));
x = G__103223;
level__$1 = G__103224;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__103227 = nx;
var G__103228 = (level__$1 - (1));
x = G__103227;
level__$1 = G__103228;
continue;
} else {
var G__103229 = x;
var G__103230 = (level__$1 - (1));
x = G__103229;
level__$1 = G__103230;
continue;
}
