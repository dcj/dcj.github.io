...
var len__4736__auto___99846 = arguments.length;
var i__4737__auto___99847 = (0);
while(true){
if((i__4737__auto___99847 < len__4736__auto___99846)){
args__4742__auto__.push((arguments[i__4737__auto___99847]));

var G__99848 = (i__4737__auto___99847 + (1));
i__4737__auto___99847 = G__99848;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__99704_99850 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__99705_99851 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__99706_99852 = true;
var _STAR_print_fn_STAR__temp_val__99707_99853 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__99706_99852);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__99707_99853);

try{var _STAR_print_level_STAR__orig_val__99710_99859 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__99711_99860 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__99711_99860);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__99710_99859);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__99705_99851);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__99704_99850);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq99688){
...
var new_formatters = current_formatters.filter((function (p1__99765_SHARP_){
...
var G__99770_99913 = f;
var target__95184__auto___99914 = G__99770_99913;
if(cljs.core.truth_(target__95184__auto___99914)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__99770_99913)].join(''),"\n","target__95184__auto__"].join('')));
}

(target__95184__auto___99914["toString"] = (function (){
...
var G__99776_99920 = "%c%s";
var G__99777_99921 = "color:transparent";
var G__99778_99922 = devtools.util.make_detection_printer();
...
var args__4742__auto__ = [];
var len__4736__auto___99934 = arguments.length;
var i__4737__auto___99940 = (0);
while(true){
if((i__4737__auto___99940 < len__4736__auto___99934)){
args__4742__auto__.push((arguments[i__4737__auto___99940]));

var G__99943 = (i__4737__auto___99940 + (1));
i__4737__auto___99940 = G__99943;
continue;
} else {
}
break;
...
var vec__99796 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99796,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__99796,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__99950__delegate = function (add_fmt,add_args){
...
var G__99950 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__99951__i = 0, G__99951__a = new Array(arguments.length -  1);
while (G__99951__i < G__99951__a.length) {G__99951__a[G__99951__i] = arguments[G__99951__i + 1]; ++G__99951__i;}
  add_args = new cljs.core.IndexedSeq(G__99951__a,0,null);
} 
return G__99950__delegate.call(this,add_fmt,add_args);};
G__99950.cljs$lang$maxFixedArity = 1;
G__99950.cljs$lang$applyTo = (function (arglist__99953){
var add_fmt = cljs.core.first(arglist__99953);
var add_args = cljs.core.rest(arglist__99953);
return G__99950__delegate(add_fmt,add_args);
});
G__99950.cljs$core$IFn$_invoke$arity$variadic = G__99950__delegate;
return G__99950;
})()
);
}));
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq99790){
var G__99791 = cljs.core.first(seq99790);
var seq99790__$1 = cljs.core.next(seq99790);
var G__99792 = cljs.core.first(seq99790__$1);
var seq99790__$2 = cljs.core.next(seq99790__$1);
var G__99793 = cljs.core.first(seq99790__$2);
var seq99790__$3 = cljs.core.next(seq99790__$2);
...
var seq__99811 = cljs.core.seq(features);
var chunk__99812 = null;
var count__99813 = (0);
var i__99814 = (0);
while(true){
if((i__99814 < count__99813)){
var feature = chunk__99812.cljs$core$IIndexed$_nth$arity$2(null,i__99814);
...
var G__99972 = seq__99811;
var G__99973 = chunk__99812;
var G__99974 = count__99813;
var G__99975 = (i__99814 + (1));
seq__99811 = G__99972;
chunk__99812 = G__99973;
count__99813 = G__99974;
i__99814 = G__99975;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__99811);
if(temp__5735__auto__){
var seq__99811__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__99811__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__99811__$1);
var G__99977 = cljs.core.chunk_rest(seq__99811__$1);
var G__99978 = c__4556__auto__;
var G__99979 = cljs.core.count(c__4556__auto__);
var G__99980 = (0);
seq__99811 = G__99977;
chunk__99812 = G__99978;
count__99813 = G__99979;
i__99814 = G__99980;
continue;
} else {
var feature = cljs.core.first(seq__99811__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__99987 = cljs.core.next(seq__99811__$1);
var G__99988 = null;
var G__99989 = (0);
var G__99990 = (0);
seq__99811 = G__99987;
chunk__99812 = G__99988;
count__99813 = G__99989;
i__99814 = G__99990;
continue;
}
} else {
...
var G__99824 = feature;
var G__99824__$1 = (((G__99824 instanceof cljs.core.Keyword))?G__99824.fqn:null);
switch (G__99824__$1) {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o99836 = temp__5733__auto__;
return (o99836["version"]);
} else {
return null;
}
})() == null);
