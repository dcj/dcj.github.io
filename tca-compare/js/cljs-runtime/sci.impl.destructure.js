...
var G__106047 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__106048 = n;
var G__106049 = cljs.core.nnext(bs);
var G__106050 = true;
ret = G__106047;
n = G__106048;
bs = G__106049;
seen_rest_QMARK_ = G__106050;
continue;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__105892_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__105892_SHARP_);
}
})(),cljs.core.name(p1__105892_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__105893_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4126__auto__ = mkns;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return cljs.core.namespace(p1__105893_SHARP_);
}
})(),cljs.core.name(p1__105893_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__105894_SHARP_,p2__105895_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__105894_SHARP_,p2__105895_SHARP_,(function (){var fexpr__106014 = cljs.core.val(entry);
return (fexpr__106014.cljs$core$IFn$_invoke$arity$1 ? fexpr__106014.cljs$core$IFn$_invoke$arity$1(p2__105895_SHARP_) : fexpr__106014.call(null,p2__105895_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__106027 = cljs.core.key(entry);
return (fexpr__106027.cljs$core$IFn$_invoke$arity$1 ? fexpr__106027.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__106027.call(null,bes));
})());
...
var G__106075 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__106076 = cljs.core.next(bes);
ret = G__106075;
bes = G__106076;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__105896_SHARP_){
return (cljs.core.first(p1__105896_SHARP_) instanceof cljs.core.Keyword);
}),bents));
