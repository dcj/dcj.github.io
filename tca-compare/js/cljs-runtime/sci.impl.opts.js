...
var len__4736__auto___108987 = arguments.length;
var i__4737__auto___108988 = (0);
while(true){
if((i__4737__auto___108988 < len__4736__auto___108987)){
args__4742__auto__.push((arguments[i__4737__auto___108988]));

var G__108989 = (i__4737__auto___108988 + (1));
i__4737__auto___108988 = G__108989;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq108944){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq108944));
}));
...
var G__109000 = null;
var G__109000__1 = (function (msg){
return (new Error(msg));
});
var G__109000__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__109000__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__109000 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__109000__1.call(this,msg);
case 2:
return G__109000__2.call(this,msg,filename);
case 3:
return G__109000__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__109000.cljs$core$IFn$_invoke$arity$1 = G__109000__1;
G__109000.cljs$core$IFn$_invoke$arity$2 = G__109000__2;
G__109000.cljs$core$IFn$_invoke$arity$3 = G__109000__3;
return G__109000;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__108948_SHARP_){
return (new cljs.core.Delay(p1__108948_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__108951_SHARP_){
return (new goog.string.StringBuffer(p1__108951_SHARP_));
})], null)], null);
...
var vec__108961 = temp__5733__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108961,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__108961,(1),null);
var G__109014 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__109015 = cljs.core.rest(kvs);
class__GT_opts = G__109014;
kvs = G__109015;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__108969){
var map__108970 = p__108969;
var map__108970__$1 = (((((!((map__108970 == null))))?(((((map__108970.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__108970.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__108970):map__108970);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var dry_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__108970__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var ctx = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"features","features",-1146962336),new cljs.core.Keyword("sci.impl.opts","ctx","sci.impl.opts/ctx",-367410399),new cljs.core.Keyword(null,"bindings","bindings",1271397192),new cljs.core.Keyword(null,"readers","readers",-2118263030),new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"allow","allow",-1857325745),new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543),new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647),new cljs.core.Keyword(null,"deny","deny",1589338523)],[features,true,cljs.core.PersistentArrayMap.EMPTY,readers,env__$1,sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"allow","allow",-1857325745).cljs$core$IFn$_invoke$arity$1(preset__$1),allow], 0)),(function (){var or__4126__auto__ = realize_max;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543).cljs$core$IFn$_invoke$arity$1(preset__$1);
}
})(),dry_run,sci.impl.opts.process_permissions.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"deny","deny",1589338523).cljs$core$IFn$_invoke$arity$1(preset__$1),deny], 0))]),sci.impl.opts.normalize_classes(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([sci.impl.opts.default_classes,classes], 0)))], 0));
return ctx;
});
