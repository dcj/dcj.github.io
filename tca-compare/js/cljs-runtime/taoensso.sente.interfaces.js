...
var taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_108010 = (function (sch){
...
return taoensso$sente$interfaces$IServerChan$sch_open_QMARK_$dyn_108010(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_108012 = (function (sch){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_close_BANG_$dyn_108012(sch);
}
});

var taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_108013 = (function (sch,websocket_QMARK_,msg){
var x__4428__auto__ = (((sch == null))?null:sch);
...
return taoensso$sente$interfaces$IServerChan$sch_send_BANG_$dyn_108013(sch,websocket_QMARK_,msg);
}
});
...
var taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_108014 = (function (sch_adapter,ring_req,callbacks_map){
...
return taoensso$sente$interfaces$IServerChanAdapter$ring_req__GT_server_ch_resp$dyn_108014(sch_adapter,ring_req,callbacks_map);
}
});
...
var taoensso$sente$interfaces$IPacker$pack$dyn_108015 = (function (_,x){
...
return taoensso$sente$interfaces$IPacker$pack$dyn_108015(_,x);
}
});

var taoensso$sente$interfaces$IPacker$unpack$dyn_108016 = (function (_,x){
var x__4428__auto__ = (((_ == null))?null:_);
...
return taoensso$sente$interfaces$IPacker$unpack$dyn_108016(_,x);
}
});
